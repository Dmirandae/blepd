...
The tree corresponds to a Total Evidence analysis for the _Rhynoclemmys_ genus, and we want to test whether the branch lengths will have any effect in the areas chosen using a Pylgenetic Diversity (PD) analysis.
