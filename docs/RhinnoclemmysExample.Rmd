...
longer branches, _R._ _aerolata_ (Al) and _R._ _rubida_ (Pl), while Al
and Cho-Ph are the richest.
...
changes from XXXX to YYY. As the terminal branch lengths are distributed
unequally, we might suspect that the results depend heavily on the
longest branches that inhabit the area A.
