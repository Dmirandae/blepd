...
The function to perfomr the analysis is *swapBL*, that has four parameters: the tree, the distribution, the model to evaluate (valid models are "simpleswap"-the default-, "allswap" and "uniform"), and the number of times to swap (default value = 100).
...
Again, as this is a tree where all branches are equal, there is no impact when the branch lengths are swapped. 
