...
In all three cases _R._ _diademata_ changes the selected to second optional area, what might suggests that this species, its distribution (only in area B) or its branch length, could be leading the results.

to test our hypothesis, we can delete the species or we could remove the species or change its branch length ot zero, or change its distribution to null, and rerun the analysis.
...
As expected, now all trees give the same result, they select the area F.
