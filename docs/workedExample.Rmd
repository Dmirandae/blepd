...
In all three cases _R._ _diademata_ changes the initial selection to the second "optional" area, what might suggests that this species, its distribution (only in area B) or its branch length, could be leading the results.
