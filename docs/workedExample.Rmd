...
RhinoclemmysData$nameTrees <- rownames(RhinoclemmysData$matrixPD) <- gsub("Rhinoclemmys_","",
...
p0 <-    ggtree(RhinoclemmysData$trees[[treeNumber]], layout="slanted", ladderize=TRUE,
                ##color=c("red","blue","red","blue","black","black","black"),
                color=c("black"),
                 size=0.5 ) + 
         theme(legend.position="right") + 
...
p <- p0 %<+% RhinoclemmysData$evalPD[[treeNumber]] + 
             geom_tiplab(aes(color=areaDelta), size =5) +
             scale_colour_brewer("Area change", palette="Dark2")
