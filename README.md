...
2. The behavior of PD when terminal or internal branch lengths are swapped or replaced with a known distribution (sort of using a null model).

A worked example (using _Rhinoclemmys_) can be found at [https://github.com/Dmirandae/blepd/blob/primary/docs/RhinoclemmysExample.pdf].
